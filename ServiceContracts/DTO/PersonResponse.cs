...
namespace ServiceContracts.DTO
{
    ...
    public class PersonResponse
    {
        ...
        {
            return $"Person ID: {PersonID}, Person Name: {PersonName}, Email: {Email}, Date of Birth: {DateOfBirth?.ToString("dd MMM yyyy")}, Address: {Address}, Gender: {Gender}, Country ID: {CountryID}, Country: {Country}";
        }
        ...
        public PersonUpdateRequest ToPersonUpdateRequest()
        {
            ...
            {
                PersonID = PersonID, PersonName = PersonName, Email = Email, Address = Address, DateOfBirth = DateOfBirth, Gender = (GenderOptions) Enum.Parse(typeof(GenderOptions), Gender, true), CountryID = CountryID, ReceiveNewsLetters = ReceiveNewsLetters
            };
        }
    }
